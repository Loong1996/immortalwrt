...
Usage: gen.py page.html src/net/httpd.c
...
stays as written and the CSS loses only its comments; the main script is
minified first (jsmin.py, which needs node and test/'s npm install).
"""
import re
import sys
