...
ORDER = [
    ...
    "boot_tftp_forever", "web_uboot_boot_forever", "web_uboot_ramboot",
    "boot_tftp_production",
    ...
    "web_uboot_no_ubi", "web_uboot_foreign_ubi", "web_uboot_env_check",
    "web_uboot_env_unreadable", "_switch_to_menu",
